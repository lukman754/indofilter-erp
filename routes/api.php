...
Route::post('/documents/{document}/upload-supporting', [DocumentController::class, 'uploadSupportingDocument']);
Route::post('/documents/{document}/delete-supporting', [DocumentController::class, 'deleteSupportingDocument']);
Route::get('/documents/{document}/download-supporting/{filename}', [DocumentController::class, 'downloadSupportingDocument']);
...
Route::post('/settings/change-drive-letter', [SettingController::class, 'changeDriveLetter']);
