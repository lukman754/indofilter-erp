...
const isActive = (path) => {
    ...
    if (path.includes("?")) {
        ...
        for (const [key, val] of params.entries()) {
            if (
                decodeURIComponent(route.query[key] || "") !==
...
const menuItems = [
    ...
    },
    {
        ...
        children: [
            ...
            {
                path: "/documents?type=Proforma%20Invoice",
    ...
    },
    {
        ...
        children: [
            {
                path: "/documents?type=Delivery%20Slip",
                label: "Surat Jalan",
                icon: "M9 17a2 2 0 11-4 0 2 2 0 014 0zM19 17a2 2 0 11-4 0 2 2 0 014 0z M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10a1 1 0 001 1h1m8-1a1 1 0 01-1 1H9m4-1V8a1 1 0 011-1h2.586a1 1 0 01.707.293l2.414 2.414a1 1 0 01.293.707V16a1 1 0 01-1 1h-1",
            },
            {
                path: "/documents?type=Delivery%20Address",
                label: "Alamat Surat",
    ...
    },
    {
        ...
        children: [
            {
                path: "/documents?type=Purchase%20Order",
...
<template>
    <aside
        class="bg-odoo-sidebar text-gray-300 flex flex-col transition-all duration-300 select-none"
        :class="collapsed ? 'w-16' : 'w-56'"
    >
        <div class="h-14 flex items-center px-4 border-b border-gray-700">
            <div v-if="!collapsed" class="flex items-center gap-2">
                <div
                    class="w-7 h-7 rounded bg-indofilter flex items-center justify-center"
                >
                    <svg
            ...
            <div v-for="item in menuItems" :key="item.label" class="mb-1">
                <div v-if="!item.children" class="px-2">
                    <button
                        ...
                        :class="[
                            isActive(item.path)
                                ? 'bg-odoo-brand text-white font-medium'
                ...
                <div v-else class="space-y-1">
                    <div
                        class="flex items-center gap-3 py-2 text-[10px] font-bold text-gray-500 uppercase tracking-wider"
                    ...
                    <div class="space-y-0.5 px-2">
                        <button
                            ...
                            :class="[
                                ...
                                collapsed
                                    ? 'justify-center py-2 px-0'
                                    : 'gap-3 px-4 py-2 text-xs-custom',
                            ]"
                            :title="child.label"
                        >
                            <svg
        ...
        <div class="border-t border-gray-700 p-2">
            <button
                ...
                class="w-full flex items-center gap-3 px-3 py-2 rounded-custom text-gray-500 hover:text-white hover:bg-gray-700 transition-colors"
            >
                <svg
                    class="w-4 h-4 flex-shrink-0"
                    fill="none"
